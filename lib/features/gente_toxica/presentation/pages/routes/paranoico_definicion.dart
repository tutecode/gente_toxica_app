          ...
          children: <Widget>[
            Container(
              ...
              child: RichText(
                ...
                text: TextSpan(
                  text:
                      'La paranoia, por decirlo de manera cotidiana, es una «manera de funcionar», una forma de vivir. Y, generalmente, sin importar el lugar donde se encuentre la persona que la padece, en todas partes se desenvolverá y responderá de la misma manera.',
                  style: monoRegular,
                  children: <TextSpan>[
                    TextSpan(
                      text:
